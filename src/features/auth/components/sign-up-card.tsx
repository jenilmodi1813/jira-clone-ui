...
export function SignUpCard() {
    ...
    const handleEmailSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Call Signup API
        try {
            await authService.signup({ email: emailInput })
            setEmail(emailInput)
            setStep("otp")
        } catch (error: any) {
            console.error(error)
    ...
    const handleOtpSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await authService.verifyEmail({ email, verificationCode: code })
            ...
            if (res?.error) {
                setError("Verification successful but login failed")
            } else {
        ...
        return (
            <AuthCard error={error}>
                ...
                <form onSubmit={handleOtpSubmit} className="space-y-6">
                    ...
                    >
                        {isLoading ? <Loader2 size={18} className="animate-spin" /> : "Verify and sign up"}
                    </button>
    ...
    return (
        <AuthCard error={error}>
            <div className="flex flex-col items-center mb-6">
                ...
                <h1 className="text-base font-bold text-[#172b4d]">Sign up to continue</h1>
            </div>
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-4">
                ...
                <div className="text-xs text-[#5e6c84] leading-relaxed">
                    By signing up, I accept the Atlassian Cloud <a href="#" className="text-[#0052cc] hover:underline">Terms of Service</a> and acknowledge the <a href="#" className="text-[#0052cc] hover:underline">Privacy Policy</a>.
                </div>
            ...
            <div className="mt-6 border-t border-[var(--border)] pt-4 text-center">
                <Link href="/login" className="text-[#0052cc] hover:underline text-sm">
