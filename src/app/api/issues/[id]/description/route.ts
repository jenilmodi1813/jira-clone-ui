...
export async function PATCH(
    ...
    try {
        ...
        // Backend Endpoint: PATCH http://localhost:8087/api/issues/{id}/description
        const response = await fetch(`http://localhost:8080/api/issues/${id}/description`, {
            method: "PATCH",
            headers: {
        ...
        console.error("Update Issue Description Proxy Error:", error);
